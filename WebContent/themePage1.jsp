...
<html>
   ...
   $(document).ready(function() { 
      $.getJSON('./json/food.json', function(data) { 
         ...
         $.each(data, function(index, item) { 
            img1.push("<img style = 'width:100%; height:auto;' src ="+ item.Info[0].images+ ">" + '<br>')
         });
         $('#img1').html(img1.join(''));
      }); 
   });
   ...
   $(document).ready(function() { 
      $.getJSON('./json/food.json', function(data) { 
         ...
         $.each(data, function(index, item) { 
            img2.push("<img style = 'width:100%; height:auto;' src ="+ item.Info[1].images+ ">" + '<br>')
         });
         $('#img2').html(img2.join(''));
      }); 
   });
   ...
   $(document).ready(function() { 
      $.getJSON('./json/food.json', function(data) { 
         ...
         $.each(data, function(index, item) { 
            img3.push("<img style = 'width:100%; height:auto;' src ="+ item.Info[2].images+ ">" + '<br>')
         });
         $('#img3').html(img3.join(''));
      }); 
   });
   ...
   $(document).ready(function() { 
      $.getJSON('./json/food.json', function(data) { 
         ...
         $.each(data, function(index, item) { 
            img4.push("<img style = 'width:100%; height:auto;' src ="+ item.Info[3].images+ ">" + '<br>')
         });
         $('#img4').html(img4.join(''));
      }); 
   });
   ...
   $(document).ready(function() { 
      $.getJSON('./json/food.json', function(data) { 
         ...
         $.each(data, function(index, item) { 
            img5.push("<img style = 'width:100%; height:auto;' src ="+ item.Info[4].images+ ">" + '<br>')
         });
         $('#img5').html(img5.join(''));
      }); 
   });
   ...
   $(document).ready(function() { 
      $.getJSON('./json/food.json', function(data) { 
         ...
         $.each(data, function(index, item) { 
            img6.push("<img style = 'width:100%; height:auto;' src ="+ item.Info[5].images+ ">" + '<br>')
         });
         $('#img6').html(img6.join(''));
      }); 
   });
   ...
   $(document).ready(function() { 
      $.getJSON('./json/food.json', function(data) { 
         ...
         $.each(data, function(index, item) { 
            img7.push("<img style = 'width:100%; height:auto;' src ="+ item.Info[6].images+ ">" + '<br>')
         });
         $('#img7').html(img7.join(''));
      }); 
   });
   ...
   %>   
      ...
      <header>
         <div style="padding-bottom: 10px; background-color: #d6d2d2">
            ...
            <center>
            <p><%=now %></p>
            <h1>학교 주변 가볍게 먹을 수 있는!!</h1><br>
            <h5>오늘 점심은 뭐 먹지? 학교 주변 간단히 먹을 것 없나?</h5><br>
            </center>
         </div>
      </header>
