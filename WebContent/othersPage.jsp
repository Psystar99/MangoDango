...
<html>
	...
	<title>MANGOMANGO_othersPage</title>
...
<%
   ...
   %>   
      ...
      <nav class="gtco-nav" role="navigation">
		...
		<img class = "user-image" src = "images/mypage_icon.png">
		</div>
		<div id = "div_mypage">
			<font size = "6"><b>정용찡</b>이  찜한 음식점 (3)</font><br><br>
				<div id = "pickbox">
		...
		<div id = "div_mypage2">
			<font size = "6"><b>정용찡</b>이  쓴 리뷰 (3)</font><br><br>
			<div id = "pickbox">
				<a href = "음식점 페이지"><img class = "max-small" src = "images/한솥.jpg"></a>
				<div id = "review-text">
