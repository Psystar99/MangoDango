...
<html>
	...
	$(document).ready(function() { 
		$.getJSON('./json/food.json', function(data) { 
			...
			$.each(data, function(index, item) { 
				info1.push('<a href = "한솥.jsp" style = "text-decoration:none; ">' + '<h3>' + item.Info[1].Index + ". " + item.Info[30].Name + '</h3>' + '</a>');
	...
	$(document).ready(function() { 
		$.getJSON('./json/food.json', function(data) { 
			...
			$.each(data, function(index, item) { 
				info2.push('<a href = "한솥.jsp" style = "text-decoration:none; ">' + '<h3>' + item.Info[2].Index + ". " + item.Info[31].Name + '</h3>' + '</a>');
	...
	$(document).ready(function() { 
		$.getJSON('./json/food.json', function(data) { 
			...
			$.each(data, function(index, item) { 
				info3.push('<a href = "한솥.jsp" style = "text-decoration:none; ">' + '<h3>' + item.Info[3].Index + ". " + item.Info[32].Name + '</h3>' + '</a>');
	...
	$(document).ready(function() { 
		$.getJSON('./json/food.json', function(data) { 
			...
			$.each(data, function(index, item) { 
				info4.push('<a href = "한솥.jsp" style = "text-decoration:none; ">' + '<h3>' + item.Info[4].Index + ". " + item.Info[33].Name + '</h3>' + '</a>');
	...
	$(document).ready(function() { 
		$.getJSON('./json/food.json', function(data) { 
			...
			$.each(data, function(index, item) { 
				info5.push('<a href = "한솥.jsp" style = "text-decoration:none; ">' + '<h3>' + item.Info[5].Index + ". " + item.Info[34].Name + '</h3>' + '</a>');
	...
	$(document).ready(function() { 
		$.getJSON('./json/food.json', function(data) { 
			...
			$.each(data, function(index, item) { 
				info6.push('<a href = "한솥.jsp" style = "text-decoration:none; ">' + '<h3>' + item.Info[6].Index + ". " + item.Info[35].Name + '</h3>' + '</a>');
