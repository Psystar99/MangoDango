...
<html>
	...
	<div id="page">
		...
		<div class="gtco-container"><br>
			<h1 align = "center"><b>리뷰 &nbsp&nbsp작성하기</h1>
			<img id = "addPic" src = "images/pen.png" alt = ""><br><br>&nbsp<hr>
			<textarea placeholder = "리뷰를 작성해주세요."></textarea><br><br><br><br>
			<div class = "like">
				<h2 align = "center"><b>평점 남기기</h2>
				<hr><br>
				<div id = "center-zzim">
				<img id = "review-star2" src = "images/zzim.png"><img id = "review-star2" src = "images/zzim.png"><img id = "review-star2" src = "images/zzim.png"><img id = "review-star2" src = "images/zzim.png"><img id = "review-star2" src = "images/zzim.png">
				</div>
				<br><br><br><br><br>
