...
<html>
   ...
   $(document).ready(function() { 
      $.getJSON('./json/food.json', function(data) { 
         ...
         $.each(data, function(index, item) { 
            info1.push('<a href="fshopPage.jsp?fshopid=22" style = "text-decoration:none; ">' + '<h3>' + item.Info[1].Index + ". " + item.Info[22].Name + '</h3>' + '</a>');
            ...
            info1.push('<a href="fshopPage.jsp?fshopid=22" style = "text-decoration:none; text-align:right;">더보기..</a>');
         });
   ...
   $(document).ready(function() { 
      $.getJSON('./json/food.json', function(data) { 
         ...
         $.each(data, function(index, item) { 
            info2.push('<a href="fshopPage.jsp?fshopid=23" style = "text-decoration:none; ">' + '<h3>' + item.Info[2].Index + ". " + item.Info[23].Name + '</h3>' + '</a>');
            ...
            info2.push('<a href="fshopPage.jsp?fshopid=23" style = "text-decoration:none; text-align:right;">더보기..</a>');
         });
   ...
   $(document).ready(function() { 
      $.getJSON('./json/food.json', function(data) { 
         ...
         $.each(data, function(index, item) { 
            info3.push('<a href="fshopPage.jsp?fshopid=24" style = "text-decoration:none; ">' + '<h3>' + item.Info[3].Index + ". " + item.Info[24].Name + '</h3>' + '</a>');
            ...
            info3.push('<a href="fshopPage.jsp?fshopid=24" style = "text-decoration:none; text-align:right;">더보기..</a>');
         });
   ...
   $(document).ready(function() { 
      $.getJSON('./json/food.json', function(data) { 
         ...
         $.each(data, function(index, item) { 
            info4.push('<a href="fshopPage.jsp?fshopid=25" style = "text-decoration:none; ">' + '<h3>' + item.Info[4].Index + ". " + item.Info[25].Name + '</h3>' + '</a>');
            ...
            info4.push('<a href="fshopPage.jsp?fshopid=25" style = "text-decoration:none; text-align:right;">더보기..</a>');
         });
   ...
   $(document).ready(function() { 
      $.getJSON('./json/food.json', function(data) { 
         ...
         $.each(data, function(index, item) { 
            info5.push('<a href="fshopPage.jsp?fshopid=26" style = "text-decoration:none; ">' + '<h3>' + item.Info[5].Index + ". " + item.Info[26].Name + '</h3>' + '</a>');
            ...
            info5.push('<a href="fshopPage.jsp?fshopid=26" style = "text-decoration:none; text-align:right;">더보기..</a>');
         });
   ...
   $(document).ready(function() { 
      $.getJSON('./json/food.json', function(data) { 
         ...
         $.each(data, function(index, item) { 
            info6.push('<a href="fshopPage.jsp?fshopid=27" style = "text-decoration:none; ">' + '<h3>' + item.Info[6].Index + ". " + item.Info[27].Name + '</h3>' + '</a>');
            ...
            info6.push('<a href="fshopPage.jsp?fshopid=27" style = "text-decoration:none; text-align:right;">더보기..</a>');
         });
   ...
   $(document).ready(function() { 
      $.getJSON('./json/food.json', function(data) { 
         ...
         $.each(data, function(index, item) { 
            info7.push('<a href="fshopPage.jsp?fshopid=28" style = "text-decoration:none; ">' + '<h3>' + item.Info[7].Index + ". " + item.Info[28].Name + '</h3>' + '</a>');
            ...
            info7.push('<a href="fshopPage.jsp?fshopid=28" style = "text-decoration:none; text-align:right;">더보기..</a>');
         });
   ...
   $(document).ready(function() { 
      $.getJSON('./json/food.json', function(data) { 
         ...
         $.each(data, function(index, item) { 
            info8.push('<a href="fshopPage.jsp?fshopid=29" style = "text-decoration:none; ">' + '<h3>' + item.Info[8].Index + ". " + item.Info[29].Name + '</h3>' + '</a>');
            ...
            info8.push('<a href="fshopPage.jsp?fshopid=29" style = "text-decoration:none; text-align:right;">더보기..</a>');
         });
