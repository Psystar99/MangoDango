...
<html>
	...
	$(document).ready(function() { 
		$.getJSON('./json/food.json', function(data) { 
			...
			$.each(data, function(index, item) { 
				img1.push("<img style = 'width:100%; height:auto;' src ="+ item.Info[14].images+ ">" + '<br>')
			});
			$('#img1').html(img1.join(''));
		}); 
	});
	...
	$(document).ready(function() { 
		$.getJSON('./json/food.json', function(data) { 
			...
			$.each(data, function(index, item) { 
				img2.push("<img style = 'width:100%; height:auto;' src ="+ item.Info[15].images+ ">" + '<br>')
			});
			$('#img2').html(img2.join(''));
		}); 
	});
	...
	$(document).ready(function() { 
		$.getJSON('./json/food.json', function(data) { 
			...
			$.each(data, function(index, item) { 
				img3.push("<img style = 'width:100%; height:auto;' src ="+ item.Info[16].images+ ">" + '<br>')
			});
			$('#img3').html(img3.join(''));
		}); 
	});
	...
	$(document).ready(function() { 
		$.getJSON('./json/food.json', function(data) { 
			...
			$.each(data, function(index, item) { 
				img4.push("<img style = 'width:100%; height:auto;' src ="+ item.Info[17].images+ ">" + '<br>')
			});
			$('#img4').html(img4.join(''));
		}); 
	});
	...
	$(document).ready(function() { 
		$.getJSON('./json/food.json', function(data) { 
			...
			$.each(data, function(index, item) { 
				img5.push("<img style = 'width:100%; height:auto;' src ="+ item.Info[18].images+ ">" + '<br>')
			});
			$('#img5').html(img5.join(''));
		}); 
	});
	...
	$(document).ready(function() { 
		$.getJSON('./json/food.json', function(data) { 
			...
			$.each(data, function(index, item) { 
				img6.push("<img style = 'width:100%; height:auto;' src ="+ item.Info[19].images+ ">" + '<br>')
			});
			$('#img6').html(img6.join(''));
		}); 
	});
	...
	$(document).ready(function() { 
		$.getJSON('./json/food.json', function(data) { 
			...
			$.each(data, function(index, item) { 
				img7.push("<img style = 'width:100%; height:auto;' src ="+ item.Info[20].images+ ">" + '<br>')
			});
			$('#img7').html(img7.join(''));
		}); 
	});
	...
	$(document).ready(function() { 
		$.getJSON('./json/food.json', function(data) { 
			...
			$.each(data, function(index, item) { 
				img8.push("<img style = 'width:100%; height:auto;' src ="+ item.Info[21].images+ ">" + '<br>')
			});
			$('#img8').html(img8.join(''));
		}); 
	});
	...
	$(document).ready(function() { 
		$.getJSON('./json/food.json', function(data) { 
			...
			$.each(data, function(index, item) { 
				info1.push('<a href = "한솥.jsp" style = "text-decoration:none; ">' + '<h3>' + item.Info[1].Index + ". " + item.Info[14].Name + '</h3>' + '</a>');
				info1.push('종류 : ' + item.Info[14].Category+ '<br>');
				info1.push('주소 : ' + item.Info[14].Address+ '<br>');
				info1.push('홈페이지 : ' + item.Info[14].homepage + '<br>');
				info1.push('전화번호 : ' + item.Info[14].phoneNumber + '<br><br>');
	...
	$(document).ready(function() { 
		$.getJSON('./json/food.json', function(data) { 
			...
			$.each(data, function(index, item) { 
				info2.push('<a href = "한솥.jsp" style = "text-decoration:none; ">' + '<h3>' + item.Info[2].Index + ". " + item.Info[15].Name + '</h3>' + '</a>');
				info2.push('종류 : ' + item.Info[15].Category+ '<br>');
				info2.push('주소 : ' + item.Info[15].Address+ '<br>');
				info2.push('홈페이지 : ' + item.Info[15].homepage + '<br>');
				info2.push('전화번호 : ' + item.Info[15].phoneNumber + '<br><br>');
	...
	$(document).ready(function() { 
		$.getJSON('./json/food.json', function(data) { 
			...
			$.each(data, function(index, item) { 
				info3.push('<a href = "한솥.jsp" style = "text-decoration:none; ">' + '<h3>' + item.Info[3].Index + ". " + item.Info[16].Name + '</h3>' + '</a>');
				info3.push('종류 : ' + item.Info[16].Category+ '<br>');
				info3.push('주소 : ' + item.Info[16].Address+ '<br>');
				info3.push('홈페이지 : ' + item.Info[16].homepage + '<br>');
				info3.push('전화번호 : ' + item.Info[16].phoneNumber + '<br><br>');
	...
	$(document).ready(function() { 
		$.getJSON('./json/food.json', function(data) { 
			...
			$.each(data, function(index, item) { 
				info4.push('<a href = "한솥.jsp" style = "text-decoration:none; ">' + '<h3>' + item.Info[4].Index + ". " + item.Info[17].Name + '</h3>' + '</a>');
				info4.push('종류 : ' + item.Info[17].Category+ '<br>');
				info4.push('주소 : ' + item.Info[17].Address+ '<br>');
				info4.push('홈페이지 : ' + item.Info[17].homepage + '<br>');
				info4.push('전화번호 : ' + item.Info[17].phoneNumber + '<br><br>');
	...
	$(document).ready(function() { 
		$.getJSON('./json/food.json', function(data) { 
			...
			$.each(data, function(index, item) { 
				info5.push('<a href = "한솥.jsp" style = "text-decoration:none; ">' + '<h3>' + item.Info[5].Index + ". " + item.Info[18].Name + '</h3>' + '</a>');
				info5.push('종류 : ' + item.Info[18].Category+ '<br>');
				info5.push('주소 : ' + item.Info[18].Address+ '<br>');
				info5.push('홈페이지 : ' + item.Info[18].homepage + '<br>');
				info5.push('전화번호 : ' + item.Info[18].phoneNumber + '<br><br>');
	...
	$(document).ready(function() { 
		$.getJSON('./json/food.json', function(data) { 
			...
			$.each(data, function(index, item) { 
				info6.push('<a href = "한솥.jsp" style = "text-decoration:none; ">' + '<h3>' + item.Info[6].Index + ". " + item.Info[19].Name + '</h3>' + '</a>');
				info6.push('종류 : ' + item.Info[19].Category+ '<br>');
				info6.push('주소 : ' + item.Info[19].Address+ '<br>');
				info6.push('홈페이지 : ' + item.Info[19].homepage + '<br>');
				info6.push('전화번호 : ' + item.Info[19].phoneNumber + '<br><br>');
	...
	$(document).ready(function() { 
		$.getJSON('./json/food.json', function(data) { 
			...
			$.each(data, function(index, item) { 
				info7.push('<a href = "한솥.jsp" style = "text-decoration:none; ">' + '<h3>' + item.Info[7].Index + ". " + item.Info[20].Name + '</h3>' + '</a>');
				info7.push('종류 : ' + item.Info[20].Category+ '<br>');
				info7.push('주소 : ' + item.Info[20].Address+ '<br>');
				info7.push('홈페이지 : ' + item.Info[20].homepage + '<br>');
				info7.push('전화번호 : ' + item.Info[20].phoneNumber + '<br><br>');
	...
	$(document).ready(function() { 
		$.getJSON('./json/food.json', function(data) { 
			...
			$.each(data, function(index, item) { 
				info8.push('<a href = "한솥.jsp" style = "text-decoration:none; ">' + '<h3>' + item.Info[8].Index + ". " + item.Info[21].Name + '</h3>' + '</a>');
				info8.push('종류 : ' + item.Info[21].Category+ '<br>');
				info8.push('주소 : ' + item.Info[21].Address+ '<br>');
				info8.push('홈페이지 : ' + item.Info[21].homepage + '<br>');
				info8.push('전화번호 : ' + item.Info[21].phoneNumber + '<br><br>');
